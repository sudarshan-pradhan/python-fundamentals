...
# The character at the end index in the string, 
# will not be included in the substring obtained through this method.

# Python 3 also allows us to slice a string by defining a step 
# through which we can skip characters in the string. The default step is 1, 
# so we iterate through the string one character at a time.
